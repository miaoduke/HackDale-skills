...
name: Exam2Knowledge
version: 1.0.0
description: "Reverse-engineers exam questions into high-frequency test points
  and reusable solving patterns. Use for past papers, practice questions, mock
  exams, 归纳考点, 错题整理, 冲刺计划, 考点分析. Triggers: 刷题, 模考, past paper, mock exam, 考点,
  高频题, 冲刺, 备考, 题库, 归纳, 错题本. STEM-first."
agent_created: true
origin: github-AtomerCore/Exam2Knowledge-skill
source_url: https://github.com/AtomerCore/Exam2Knowledge-skill
license: MIT
